...
let PropertiesController = class PropertiesController {
    ...
    findAll(page = 1, limit = 10, search = '', type = 'all', status = 'all', isForSale, isForRent) {
        return this.propertiesService.findAll(Number(page), Number(limit), search, type, status, isForSale, isForRent);
    }
    seed() {
    ...
    async uploadImage(id, image, field) {
...
__decorate([
    ...
    __param(5, (0, common_1.Query)('isForSale')),
    __param(6, (0, common_1.Query)('isForRent')),
    __metadata("design:type", Function),
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], PropertiesController.prototype, "seed", null);
__decorate([
    (0, common_1.Get)(':id'),
...
__decorate([
    ...
    __param(2, (0, common_1.Body)('field')),
    __metadata("design:type", Function),
